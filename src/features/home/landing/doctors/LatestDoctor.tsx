  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex w-full flex-row justify-between">
        <p className="text-3xl font-bold">برترین پزشکان به‌نوبه</p>
      </div>
      <div className="flex flex-row items-center xl:justify-between 2xl:justify-center 2xl:gap-28">
        <div className="flex flex-col items-center justify-center gap-2 rounded-3xl px-4 py-3 shadow xl:w-[200px] 2xl:w-[240px]">
